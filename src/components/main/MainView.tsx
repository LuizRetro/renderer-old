...
import { RoomCatalogView } from '../room-catalog/RoomCatalogView';
import { SellRoomView } from '../room-catalog/SellRoomView';
...
export const MainView: FC<{}> = props =>
{
    ...
    function loadColors(){
        fetch("https://hgalaxy.net/system/controllers/eha.php?getColors=true&sso=" + sso)
