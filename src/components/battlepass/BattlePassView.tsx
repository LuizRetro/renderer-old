...
export const BattlePassView: FC<{}> = props =>
{
    ...
    function buyBattlePass(){
        fetch("https://hgalaxy.net/system/controllers/eha.php?buyGalaxyPass=true&sso=" + sso);
        setIsVisible(false);
    }
            ...
            linkReceived: (url: string) =>
            {
                ...
                switch(parts[1])
                {
                    case 'open':
                        ...
                        fetch("https://hgalaxy.net/system/controllers/eha.php?getInfoOpenGalaxyPassEmu=true&sso=" + sso)
