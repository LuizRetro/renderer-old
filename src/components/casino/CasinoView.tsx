...
export const CasinoView: FC<{}> = props =>
{
    ...
    function betDados(){
        fetch("https://hgalaxy.net/system/controllers/eha.php?betDadosCasino=true&quantity=" + diceBet + "&coin=" + diceCoin + "&number=" + diceNumber + "&sso="+sso);

        setIsVisible(false);
    }

    function betRuletaSuelo(){
        fetch("https://hgalaxy.net/system/controllers/eha.php?betRuletaSuelo=true&quantity=" + ruletaSueloBet + "&coin=" + ruletaSueloCoin + "&number=" + ruletaSueloNumber + "&sso="+sso);

        setIsVisible(false);
    }

    function betRuletaPared(){
        fetch("https://hgalaxy.net/system/controllers/eha.php?betRuletaPared=true&quantity=" + ruletaParedBet + "&coin=" + ruletaParedCoin + "&sso="+sso);
        ...
        <>
            { isVisible &&
                ...
                <div id="rouletteColorsView" style={{display: rouletteWall}}>
                    <div className="alert alert-primary text-center"><b>Depende del color, ganas o pierdes.<br/>Verde: x2<br/>Morado: x1.2</b></div>
                    <b style={{color: "var(--test-galaxytext)"}}>Moneda a apostar:</b>
                ...
                <div id="rouletteFloorView" style={{display: rouletteFloor}}>
                    <div className="alert alert-primary text-center"><b>Selecciona un número. Si el número es par y toca par, ganarás un x1.2 Si toca el mismo número, ganarás un x5.</b></div>
