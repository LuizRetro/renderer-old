...
export const HotelView: FC<{}> = props =>
{
    ...
    useEffect(() => {
        fetch("https://hgalaxy.net/system/controllers/eha.php?getHotelViewStats&sso=" + sso)
    ...
    return (
        ...
        <div className="nitro-hotel-view"  style={{zIndex: "9"}}>
            ...
            <div className="drape position-absolute" style={ (drape && drape.length) ? { backgroundImage: `url(https://cdn.discordapp.com/attachments/988602487961432074/1015501840495939624/logohotel.png)` } : {} } />
            ...
            <div className="right position-absolute" style={ (right && right.length) ? { backgroundImage: `url(https://cdn.discordapp.com/attachments/988602487961432074/1015502189277483028/testt.png)` } : {} } />
