...
export const RoomToolsWidgetView: FC<{}> = props =>
{
    ...
    function openBawTool(){
        fetch("https://hgalaxy.net/system/controllers/eha.php?builderTool=true&sso="+sso);
    }
    ...
    return (
        <Flex className="nitro-room-tools-container" gap={ 2 } style={{marginBottom: "45px"}}>
            <Column center className="nitro-room-tools p-2">
                ...
                <Base pointer title={ LocalizeText('room.chathistory.button.text') } onClick={ event => CreateLinkEvent('roomcatalog/show') } className="icon icon-roomcatalog" />
