            ...
            linkReceived: (url: string) =>
            {
                ...
                switch(parts[1])
                {
                    case 'show':
                        ...
                        fetch("https://hgalaxy.net/system/controllers/eha.php?getLastItemsCategory=21")
                        .then(response => response.json())
                        .then((response) => { 
                            setMegas(response);
                        })
            ...
            { isVisible &&
                ...
                <NitroCardContentView className="text-dark">
                    <Tabs defaultActiveKey="home" id="uncontrolled-tab-example" className="mb-3">
                                ...
                                { lastRares.map((rare) => 
                                    <div className="col-md-3">
                                        <div className="text-center" style={{backgroundImage: "url(https://files.habboemotion.com/resources/images/homebgs/bg_colour_07.gif)", padding: "10px", borderRadius: "3px", marginBottom: "10px"}}>
                                            ...
                                            <span className="badge bg-dark"><img src="https://swfs.hgalaxy.net/monedas/0.png" /> {rare.price_diamonds}</span><br/>
                                            <span className="badge bg-primary"><img src="https://swfs.hgalaxy.net/monedas/5.png" /> {rare.price_th}</span>
                                        </div>
                                    </div>
                                )}
                                </div>
                        ...
                        <Tab eventKey="custom" title="Rares" style={{color: "var(--test-galaxytext)"}}>
                            { custom != null &&
                                <div className="row">
                                { custom.map((rare) => 
                                    <div className="col-md-3">
                        ...
                        <Tab eventKey="rares" title="Megas" style={{color: "var(--test-galaxytext)"}}>
                            { rares != null &&
                                <div className="row">
                                { rares.map((rare) => 
                                    <div className="col-md-3">
                        ...
                        <Tab eventKey="megas" title="Ultras" style={{color: "var(--test-galaxytext)"}}>
                            { megas != null &&
                                <div className="row">
                                { megas.map((rare) => 
                                    <div className="col-md-3">
