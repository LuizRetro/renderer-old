...
export const BawToolView: FC<{}> = props =>
{
    ...
    function maxFloor(){
        fetch("https://hgalaxy.net/system/controllers/eha.php?maxFloor=true&sso="+sso);
    }

    function autoFloor(){
        fetch("https://hgalaxy.net/system/controllers/eha.php?autoFloor=true&sso="+sso);
    }

    function reloadRoom(){
        fetch("https://hgalaxy.net/system/controllers/eha.php?reloadRoom=true&sso="+sso);
    }

    function changeAltura(){
        fetch("https://hgalaxy.net/system/controllers/eha.php?cambiarAltura="+altura+"&sso="+sso);
    }

    function resetAltura(){
        fetch("https://hgalaxy.net/system/controllers/eha.php?cambiarAltura=999&sso="+sso);
    }

    function cambiarEstado(){
        fetch("https://hgalaxy.net/system/controllers/eha.php?cambiarEstado="+estado+"&sso="+sso);
    }

    function cambiarRotacion(){
        fetch("https://hgalaxy.net/system/controllers/eha.php?cambiarRotacion="+rotacion+"&sso="+sso);
    }
