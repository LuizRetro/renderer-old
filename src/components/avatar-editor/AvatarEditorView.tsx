...
import { NitroCardContentView, NitroCardView } from '../../common';
    ...
    return (
        <NitroCardView uniqueKey="avatar-editor" className="nitro-avatar-editor">
            <div className="drag-handler" >
                <div style={{padding: "10px", fontSize: "21px", fontWeight: "bold", color: "var(--test-galaxytext)", display: "inline-block"}}>Cambia tu look</div>
                { categories && (categories.size > 0) && Array.from(categories.keys()).map(category =>
                {
                    ...
                    return (
                        <div style={{display: "inline-block", backgroundColor: "var(--test-galaxytwo)", padding: "4px", borderRadius: "4px", marginRight: "5px", cursor: "pointer"}} key={ category } onClick={ event => selectCategory(category) }>
                            { LocalizeText(`avatareditor.category.${ category }`) }
                        </div>
                    );
                }) }
                <div style={{display: "inline-block", backgroundColor: "var(--test-galaxytwo)", padding: "4px", borderRadius: "4px", marginRight: "5px", cursor: "pointer"}}  onClick={ event => setIsWardrobeVisible(true) }>
