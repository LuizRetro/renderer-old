                    ...
                    <>
                            ...
                            <Column grow gap={ 1 } overflow="hidden">
                                <Flex gap={ 1 }>
                                    <Column grow gap={ 1 }>
                                        <Flex gap={ 1 }>
                                            ...
                                            <Text bold variant="none" style={{color: "--var(test-galaxytext)"}} >{ navigatorData.enteredGuestRoom.roomName }</Text>
                                        </Flex>
                                        { navigatorData.enteredGuestRoom.showOwner &&
                                            <Flex alignItems="center" gap={ 1 }>
                                                ...
                                                <Flex alignItems="center" gap={ 1 }>
                                                    ...
                                                    <Text variant="none" style={{color: "--var(test-galaxytext)"}} >{ navigatorData.enteredGuestRoom.ownerName }</Text>
                                                </Flex>
                                            </Flex> }
                                        <Flex alignItems="center" gap={ 1 }>
                                            <Text variant="muted">{ LocalizeText('navigator.roomrating') }</Text>
                                            <Text variant="none" style={{color: "--var(test-galaxytext)"}}>{ navigatorData.currentRoomRating }</Text>
                                        </Flex>
                                ...
                                { (navigatorData.enteredGuestRoom.habboGroupId > 0) &&
                                    <Flex pointer alignItems="center" gap={ 1 } onClick={ () => processAction('open_group_info') }>
                                        ...
                                        <Text variant="none" style={{color: "--var(test-galaxytext)"}} underline>
                        ...
                        <Column gap={ 1 }>
                            ...
                            <>
                                ...
                                <Button onClick={ () => CreateLinkEvent('sellroom/show') }>
                                    Vender sala
                                </Button>
                            </> }
                        </Column>
